  ...
  return (
    <div className="mx-auto w-full max-w-[390px] mt-[12px] pb-[100px]">
      <div className="px-[24px]">
        ...
        <ul className="flex gap-[10px] mt-[12px]">
          {product.sizes && product.sizes.map(s => (
            <li
              key={s.id || s.size}
              className={`w-[50px] h-[47px] border flex justify-center items-center rounded-[10px] cursor-pointer ${selectedSize === s.size ? 'bg-black text-white' : ''
                }`}
      ...
      <div className="px-[24px] flex justify-between items-center mt-[12px]">
        ...
        <button
          className={`flex items-center justify-center gap-[10px] ${addedToCart ? 'bg-green-600' : 'bg-black'
