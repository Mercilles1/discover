		...
		<div className='max-w-[390px] relative'>
			...
			>
				<div className='absolute top-[10px] left-[0]'>
					<img className='w-[100%]' src={element} alt='Background element' />
				</div>
				<div>
			...
			<div
				className={`absolute top-0 left-0 w-[100%] h-[100vh] transition-opacity duration-[1s] z-[20] overflow-y-hidden ${
