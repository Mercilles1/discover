...
function AccountPage() {
    ...
    const handleConfirmLogout = () => {
        // Clear localStorage (where auth flag is stored)
        localStorage.removeItem('isAuth');
        
        // If there is other user data in local storage, it should also be removed
    ...
    return (
        <div className={`w-[390px] pt-[20px] relative ${showLogoutForm ? 'overflow-hidden' : ''}`}>
            <div className={`${showLogoutForm ? 'filter blur-sm' : ''}`}>
                ...
                <NavLink to="/dashboard/my-orders" className="no-underline text-inherit">
                ...
                <NavLink to="/dashboard/my-details" className="no-underline text-inherit">
                ...
                <NavLink to="/dashboard/address" className="no-underline text-inherit">
                    <div className='flex px-[24px] justify-between border-t-[1px] border-[#E6E6E6] items-center py-[22px]'>
                        <div className='flex gap-[16px] justify-center items-center'>
                            <img src={adress} alt="" />
                            <p>Address Book</p>
                ...
                <NavLink to="/dashboard/payment" className="no-underline text-inherit">
                    <div className='flex px-[24px] justify-between border-t-[1px] border-[#E6E6E6] items-center py-[22px]'>
                        <div className='flex gap-[16px] justify-center items-center'>
                            <img src={card} alt="" />
                            <p>Payment Methods</p>
                ...
                <NavLink to="/dashboard/notifications" className="no-underline text-inherit">
                    <div className='flex px-[24px] justify-between border-t-[1px] border-[#E6E6E6] items-center py-[22px]'>
                        <div className='flex gap-[16px] justify-center items-center'>
                            <img src={bell} alt="" />
                            <p>Notifications</p>
                ...
                <NavLink to="/dashboard/faqs" className="no-underline text-inherit">
                    <div className='flex px-[24px] justify-between border-t-[1px] border-[#E6E6E6] items-center py-[22px]'>
                        <div className='flex gap-[16px] justify-center items-center'>
                ...
                <NavLink to="/dashboard/help-center" className="no-underline text-inherit">
                    <div className='flex px-[24px] justify-between border-t-[1px] border-[#E6E6E6] items-center py-[22px]'>
                        <div className='flex gap-[16px] justify-center items-center'>
